...
import com.ecommerce.payment.infrastructure.messaging.consumer.OrderCreatedMessage;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderCreatedMessage> consumerFactory() {
        JsonDeserializer<OrderCreatedMessage> deserializer =
                new JsonDeserializer<>(OrderCreatedMessage.class, false);
